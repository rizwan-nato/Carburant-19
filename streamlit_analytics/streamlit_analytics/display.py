...
def show_results(counts, reset_callback, unsafe_password=None):
    ...
    if show:
        ...
        col1.metric("Pageviews", counts["total_pageviews"])
        col2.metric("Script runs", counts["total_script_runs"])
        col3.metric("Time spent", utils.format_seconds(counts["total_time_seconds"]))
